...
horizontal- and vertical-scrollbar pointers and their four arrow resources,
and the audited fixed-font hidden-cursor path. It is not a complete X
cursor-font implementation.
