...
pub use dispatch::{
    CoreClient, CoreDispatchState, InitialCoreDispatch, InternAtomOutcome, PropertyChangeRequest,
    PropertyData, PropertyMode, PropertyMutationOutcome, PropertyReadOutcome, PropertyReadReply,
    PropertyReadRequest, WindowCreateOutcome, WindowCreateRequest, WindowDestroyOutcome,
    WindowGeometryReply, WindowTreeReply, dispatch_core_request, dispatch_core_request_for_client,
